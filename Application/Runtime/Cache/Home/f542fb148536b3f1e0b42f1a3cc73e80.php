...
<html>
	...
	<body>
		...
		<div class="container-fluid cont">
			...
			<a href="<?php echo U('user/goodyunzhinan');?>" style="color:#000000">
		   ...
		   <a href="<?php echo U('user/goodyuncode');?>" style="color:#000000"><div class="col-xs-12 padd_0 pad-up15 bor-b-f2 bank">
					<div class="col-xs-2 pad-r0 pad-l10">
						<span>货运流程</span>
					</div>
					<div class="col-xs-10 pad-l7">
						<img class="yh" src="/Public/img/hylc.jpg"/>
					</div>
