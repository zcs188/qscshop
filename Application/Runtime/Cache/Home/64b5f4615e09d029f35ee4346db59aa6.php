...
<html>
	...
	<body>
		...
		<div class="container-fluid cont">
			<div class="row address">
				<div class="col-xs-12">
				<?php if(is_array($info)): foreach($info as $key=>$v): ?><div class="col-xs-12 pad10 bg-fff color-4c4c4c">
						...
						<div class="infor">
							...
							<div class="editor pull-right">
								<a href="<?php echo U('user/editarea',array('id'=>$v['id']));?>"><img src="/Public/img/address/bianji.png"/>
		...
		<div class="container-fluid b">
			<div class="row">
				<div class="col-xs-12 padd_0">
					<a href="<?php echo U('user/addarea');?>"><button type="button" class="save">添加新的服务区域</button></a>
				</div>
			</div>
		</div>
	</body>
    ...
    {
        var url = "<?php echo U('user/detelearea');?>";
         $.post(url, {id:id}, function(msg){
         if(msg.state == '200') 
         {
        	  window.location.reload();
