...
<html>
	...
	<body>
		...
		<div class="cont">
			<div class="top">
				<p class="color-669900 font12">售后人员注册</p>
			</div>
			<div class="user">
			...
			<div class="user mar-t15">
				<img src="/Public/img/DL/11.png"/>
				<select name="" id="type">
					<option value="5">货运师傅</option>
					<option value="6">安装工人</option>
	...
	$(function(){	
		...
		$("#checkcode").click(function(){  
					 ...
					 else if (checked==false) 
				  {
			         ...
			         {
			             var url = "<?php echo U('user/checkcode1');?>";
