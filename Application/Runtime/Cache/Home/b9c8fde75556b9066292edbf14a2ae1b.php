...
<html>
	...
	<body>
		...
		<div class="container-fluid cont">
			<div class="row">
				<div class="col-xs-12 pad-up15 bg-fff">
					<p class="font12 color-333 heightControl-1 mar0"><?php echo ($refund["goodsName"]); ?></p>
				</div>
				<div class="col-xs-12">
				    <input type="hidden" value="<?php echo ($refund["id"]); ?>" id="detailid">
					<textarea class="font12 color-666" placeholder="退货原因（不少于10个字）" id="remark"></textarea>
				</div>
				<div class="col-xs-12 pad-up15 bg-fff">
					<p class="font15  mar0">添加图片： </p>
				</div>
		...
		<div class="b">
			<button type="button" class="color-fff font17" id="tijiao">提交申请</button>
		</div>
	</body>
		...
		$(function(){	
			  $("#tijiao").click(function(){  
			         ...
			         else if(image2=="/Public/img/tianjia.png")
		        	 {
			             ...
			             var url = "<?php echo U('good/applyrefund');?>";
			             $.post(url, {remark:remark,image:image,image1:image1,image2:image2,detailid:detailid}, function(msg){
			             if(msg.state=='200'){
